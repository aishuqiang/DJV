@echo off
REM Build DJV and create a portable ZIP package (no NSIS installer).
set SOURCE_DIR=%~1
set BUILD_TYPE=%~2
...
echo.
echo Portable package created in build-%BUILD_TYPE%:
dir /b build-%BUILD_TYPE%\djv-*-windows-*.zip 2>nul
